                            ...
                            <div class="app-card-body">
                                <form wire:submit.prevent="addTeam()">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Hakkında" name="about" class="form-control" wire:model="about"
                                        required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label for="setting-input-2" class="form-label">Branşı </label>:
                                        <input type="text"  name="pozition" class="form-control" wire:model="pozition"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="image" wire:model="image" required /><br> <br>
