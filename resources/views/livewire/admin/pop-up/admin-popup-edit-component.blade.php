    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Popup</h1>
                <hr class="mb-4">
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-4">
                        <h3 class="section-title">Popup Düzenle</h3>
                        <div class="section-intro">Popup ögesini düzenleyin<a href="{{ route('admin.help') }}"><br>
                                Daha
                                Fazla Öğren</a></div>
                    </div>
                            ...
                            @if (Session::has('message'))
                                <div class="alert alert-success">
                                    <strong>{{ Session::get('message') }}</strong> <a style="color: red"
                                        href="{{ route('admin.popup') }}"> Popup Görüntüle</a>
                                </div>
                            @endif
                            <div class="app-card-body">
                                <form wire:submit.prevent="updateSlider()">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control" wire:model="name"
                                            required>


                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-2" class="form-label">Url </label>:
                                        <input type="text" name="title" class="form-control" wire:model="url"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/popup') }}/{{ $image }}" width="120">
                                        @endif
                                    </div>
                                    <div class="mb-3">
