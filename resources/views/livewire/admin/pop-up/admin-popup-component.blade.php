        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Slider Yönetimi</h1>
                    </div>
                                            ...
                                            @foreach ($popup as $s)
                                                <tr>
                                                    ...
                                                    <td class="cell"><img width="150px"
                                                            src="{{ asset('storage/popup') }}/{{ $s->image }}"
                                                            ></td>

                                                    <td class="cell"><span class="truncate">{{ $s->name }}</span>
                                                    </td>

                                                    <td class="cell"><span class="truncate"><a target="_blank" href="{{ $s->url }}"> {{ $s->url }} </a></span>
                                                    </td>

                                                    <td class="cell"><span class="truncate">{{ $s->durum }}</span>
                                                    </td>

                                               
                                                    <td class="cell"><a class="btn-sm app-btn-secondary"
                                                            href="{{ route('admin.popup.edit', ['popup_id' => $s->id]) }}">Düzenle
